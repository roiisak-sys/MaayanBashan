...
מערכת הפקת תעודות הסיום לבוגרי הקורס (יולי 2026) נמצאת בכתובת `/certificate`.
תיעוד מלא: [CERTIFICATES.md](./CERTIFICATES.md)

האימות מתבצע לפי **השם** מול רשימת המשתתפים ששילמו בקורס יולי 2026. מספר תעודת
הזהות שהוזן מודפס על התעודה, ואם השדה ריק ב-Airtable הוא גם נשמר שם — כך
שהמאגר מתמלא מעצמו. מרגע שנשמרה ת"ז, כל בקשה נוספת חייבת להתאים לה.

**לתשומת לבך:** מאחר שהאימות הוא לפי שם בלבד, מי שיודע את שמו של משתתף יכול
להפיק את התעודה שלו. הסבר מלא על שיקולי האבטחה נמצא ב-[CERTIFICATES.md](./CERTIFICATES.md).
