...
**חשוב לפני העלייה לאוויר:** שדה `ID` בטבלת הלידים ב-Airtable ריק כרגע עבור כל
המשתתפים, ולכן האימות לא יצליח לאף אחד עד שימולאו מספרי תעודות הזהות. פרטים
והסבר על החלופה הזמנית נמצאים ב-[CERTIFICATES.md](./CERTIFICATES.md).
